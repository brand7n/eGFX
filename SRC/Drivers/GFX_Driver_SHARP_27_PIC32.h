/*$T src/Drivers/GFX_Driver_SHARP_27_PIC32.h GC 1.150 2014-05-07 20:19:39 */
...
#define GFX_PHYSICAL_SCREEN_SIZE_X	((uint16_t) 400)	//This is the actual X and Y size of the physical screen in *pixels*
#define GFX_PHYSICAL_SCREEN_SIZE_Y	((uint16_t) 240)
...
void	GFX_DumpBitplaneToPhysicalScreen(BitPlane *Image);
void	GFX_Init();
