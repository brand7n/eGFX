...
{
    eGFX_ImagePlaneInit(&eGFX_BackBuffer,&BackBufferStore[0],eGFX_PHYSICAL_SCREEN_SIZE_X, eGFX_PHYSICAL_SCREEN_SIZE_Y,eGFX_IMAGE_PLANE_1BPP);
    ...
    for(y=0; y<eGFX_PHYSICAL_SCREEN_SIZE_Y; y++)
        {
            ...
            for(x=0; x<50; x++)
                {
                    Junk = SHARP_SPI_TRANSFER(~(eGFX_ImagePlane_GetByte(Image, x*8 ,y)));
                }
