...
#ifndef _GFX_DRIVER_LEDMATRIX_H
#define _GFX_DRIVER_LEDMATRIX_H



#define eGFX_PHYSICAL_SCREEN_SIZE_X	((uint16_t) 64)	//This is the actual X and Y size of the physical screen in *pixels*
